package k.bs.infinityscroll.util
...
import k.bs.infinityscroll.api.gson.GsonHelper
...
fun Bundle.putObject(obj: Any): Bundle {
    putString(KEY_FOR_JSON_OBJECT, GsonHelper.toJson(obj))
    return this
}

fun Intent.putObject(obj: Any): Intent {
    putExtra(KEY_FOR_JSON_OBJECT, GsonHelper.toJson(obj))
    return this
}
